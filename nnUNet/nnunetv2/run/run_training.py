...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    dataset_json = load_json(join(preprocessed_dataset_folder_base, dataset_identifier + '.json'))
...
def run_ddp(rank, dataset_name_or_id, configuration, fold, tr, d, p, use_compressed, disable_checkpointing, c, val, pretrained_weights, npz, world_size):
...
def run_training(dataset_name_or_id: Union[str, int],
    ...
    if num_gpus > 1:
        ...
        nnunet_trainer = get_trainer_from_args(dataset_name_or_id, configuration, fold, trainer_class_name,dataset_identifier,
...
def run_training_entry():
    ...
    parser.add_argument('-d', type=str, required=False, default='dataset',
                        help='[OPTIONAL] Use this flag to specify a custom dataset identifier. Default: dataset')
    ...
    run_training(args.dataset_name_or_id, args.configuration, args.fold, args.tr, args.d ,args.p, args.pretrained_weights,
