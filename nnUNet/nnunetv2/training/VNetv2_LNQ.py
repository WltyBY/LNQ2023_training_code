...
class UnetConv3(nn.Module):
    ...
    def __init__(self, in_size, out_size, dropout_p, is_batchnorm, kernel_size=(3, 3, 3), padding_size=(1, 1, 1),
                 init_stride=(1, 1, 1)):
...
class VNetv2(nn.Module):
    def __init__(self, in_channels=1, n_classes=2, is_batchnorm=True):
        ...
        self.decoder = Decoder_dropout(params_decoder_main)

        self.n_class = n_classes
        self.final = nn.Conv3d(16, self.n_class, 1)
    ...
    def forward(self, x):
        ...
        main_outfeature = self.decoder(feature)
        main_seg = self.final(main_outfeature)
...
class VNet_CCT_dropout_3D(nn.Module):
    def __init__(self, in_channels=1, n_classes=2, is_batchnorm=True):
        ...
        print("Using VNet_CCT_dropout_3D")
