...
class nnUNetPredictor(object):
    ...
    def _mix_two_output_of_model(self, x):
        return 1. * x[0] + 0. * x[1]

    def _internal_maybe_mirror_and_predict(self, x: torch.Tensor) -> torch.Tensor:
        mirror_axes = self.allowed_mirroring_axes if self.use_mirroring else None
        prediction = self._mix_two_output_of_model(self.network(x))
        ...
        if mirror_axes is not None:
            ...
            if 0 in mirror_axes:
                prediction += torch.flip(self._mix_two_output_of_model(self.network(torch.flip(x, (2,)))), (2,))
            if 1 in mirror_axes:
                prediction += torch.flip(self._mix_two_output_of_model(self.network(torch.flip(x, (3,)))), (3,))
            if 2 in mirror_axes:
                prediction += torch.flip(self._mix_two_output_of_model(self.network(torch.flip(x, (4,)))), (4,))
            if 0 in mirror_axes and 1 in mirror_axes:
                prediction += torch.flip(self._mix_two_output_of_model(self.network(torch.flip(x, (2, 3)))), (2, 3))
            if 0 in mirror_axes and 2 in mirror_axes:
                prediction += torch.flip(self._mix_two_output_of_model(self.network(torch.flip(x, (2, 4)))), (2, 4))
            if 1 in mirror_axes and 2 in mirror_axes:
                prediction += torch.flip(self._mix_two_output_of_model(self.network(torch.flip(x, (3, 4)))), (3, 4))
            if 0 in mirror_axes and 1 in mirror_axes and 2 in mirror_axes:
                prediction += torch.flip(self._mix_two_output_of_model(self.network(torch.flip(x, (2, 3, 4)))), (2, 3, 4))
